...
@module("apollo-link")
external split: (splitTest => bool, apolloLink, apolloLink) => apolloLink = "split"

/* Bind the HttpLink class */
@module("apollo-link-http") @new
external createHttpLink: ApolloClient.linkOptions => apolloLink = "HttpLink"

/* Bind the setContext method */
@module("apollo-link-context")
external apolloLinkSetContext: (unit => {..}) => apolloLink = "setContext"
...
external createUploadLink: ApolloClient.uploadLinkOptions => apolloLink = "createUploadLink"
