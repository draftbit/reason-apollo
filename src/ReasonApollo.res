 ...
 */
module CreateQuery = (Config: ReasonApolloTypes.Config) => ReasonApolloQuery.Make(Config)

/*
 * Expose a module to perform "mutation" operations for the given client
 */
module CreateMutation = (Config: ReasonApolloTypes.Config) => ReasonApolloMutation.Make(Config)
/*
 * Expose a module to perform "subscription" operations for the given client
 */
module CreateSubscription = (Config: ReasonApolloTypes.Config) => ReasonApolloSubscription.Make(
  Config,
)
